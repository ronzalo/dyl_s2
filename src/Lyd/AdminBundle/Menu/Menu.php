...
class Menu extends ContainerAware{
  ...
  protected $factory;
    ...
    public function createAdminMenu(Request $request)
    {
        ...
        $registro = $this->addNavLinkRoute($menu, 'Registro Legislativo', 'Lyd_AdminBundle_Registro_legislativo_list');

        $ministerio = $this->addNavLinkRoute($menu, 'Ministerio/Comisión', 'Lyd_AdminBundle_Ministerio_list');
        
        $investigador = $this->addNavLinkRoute($menu, 'Investigador', 'Lyd_AdminBundle_Investigador_list');
